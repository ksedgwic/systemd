...
int main(int argc, char* argv[]) {
        ...
        HASHMAP_FOREACH(p, h, i) {
                ...
                s = unit_file_get_state(UNIT_FILE_SYSTEM, root_dir, basename(p->path));
        ...
        assert_se(unit_file_get_state(UNIT_FILE_SYSTEM, root_dir, files[0]) == UNIT_FILE_ENABLED);
        ...
        assert_se(unit_file_get_state(UNIT_FILE_SYSTEM, root_dir, files[0]) == UNIT_FILE_DISABLED);
        ...
        assert_se(unit_file_get_state(UNIT_FILE_SYSTEM, root_dir, files[0]) == UNIT_FILE_MASKED);
        ...
        assert_se(unit_file_get_state(UNIT_FILE_SYSTEM, root_dir, basename(files2[0])) == UNIT_FILE_ENABLED);
        ...
        assert_se(unit_file_get_state(UNIT_FILE_SYSTEM, root_dir, basename(files2[0])) == _UNIT_FILE_STATE_INVALID);
        ...
        assert_se(unit_file_get_state(UNIT_FILE_SYSTEM, root_dir, basename(files2[0])) == UNIT_FILE_LINKED);
        ...
        assert_se(unit_file_get_state(UNIT_FILE_SYSTEM, root_dir, basename(files[0])) == UNIT_FILE_ENABLED);
